...
--
-- Name: orders order_insert_to_1; Type: RULE; Schema: public; Owner: postgres
--

CREATE RULE order_insert_to_1 AS
...
--
-- Name: orders order_insert_to_2; Type: RULE; Schema: public; Owner: postgres
--

CREATE RULE order_insert_to_2 AS
    ON INSERT TO public.orders
